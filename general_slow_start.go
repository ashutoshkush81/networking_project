//This is the general slow start in which user send the starting message , So initially clint will be
//sent the data in 1 bit and then double every time,when it's cross the window size then it will be
