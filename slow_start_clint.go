//This is the slow start in which user send the starting message , So initially clint will be
//sent the data in length equal to size of the string bit and then double every time,when it's cross the window size then it will be
//start from the previous sent window size and again it will be increses by 1, until get the correct 
//window size.
package main
